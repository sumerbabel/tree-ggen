...
function Tree({ onChange, data }: props) {
	...
	return (
		<div>
			<ul className="wtree">
				<TreeNode data={data} onChange={onChangeRecibedF} onChangeForDelete={onChangeRecibedF} render={External} />
			</ul>
		</div>
	)
}
...
export const External = (props:any) => {
	...
	return (
		<div className="ux-external"> external {props.label +"HIJO DE P"}</div>
	);
  };
